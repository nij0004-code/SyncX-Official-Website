...
(async () => {
    ...
    if (console.log("%c Zobro´s Blooket Hacks / Cheats %c\n	Modified by Zobro-On on GitHub", "color: #0bc2cf; font-size: 3rem", "color: #8000ff; font-size: 1rem"), console.log("%c	gui.js", "color: #0bc2cf; font-size: 1rem"), console.log("%c	Star the github repo!%c  https://github.com/zobroyo/Zobros-Blooket-Hacks-And-Cheats-GUI", "color: #ffd000; font-size: 1rem", ""), document.querySelector("script[src*='bfs/index.js']") && !window.clearId) {
